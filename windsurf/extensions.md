...
# C/C++
## C/C++ extension adds language support for C/C++ to Windsurf, including editing (IntelliSense) and debugging features.
#NOT WORKING FOR WINDSURF# windsurf --install-extension ms-vscode.cpptools

# Console Ninja
## console Ninja is a Windsurf extension that displays console.log output and runtime errors directly in your editor from your running browser or node application.
#NOT WORKING FOR WINDSURF# windsurf --install-extension wallabyjs.console-ninja
...
windsurf --install-extension janisdd.vscode-edit-csv

# EditorConfig for Windsurf
...
# ESLint
## integrates JavaScript into Windsurf.
windsurf --install-extension dbaeumer.vscode-eslint

# GistPad
## a Windsurf extension that allows you to edit GitHub Gists and repositories from the comfort of your favorite editor.
#NOT WORKING FOR WINDSURF# windsurf --install-extension vsls-contrib.gistfs

# Git File History
## quickly browse the history of a file from any git repository
#NOT WORKING FOR WINDSURF# windsurf --install-extension pomber.git-file-history
...
windsurf --install-extension oderwat.indent-rainbow
...
# markdownlint
## markdown linting and style checking for Windsurf
...
windsurf --install-extension cardinal90.multi-cursor-case-preserve

# Pandoc Citer
## autocomplete bibtex citations for markdown/pandoc
windsurf --install-extension notzaki.pandocciter

# Path Intellisense
## autocompletes filenames.
windsurf --install-extension christian-kohler.path-intellisense

# Peacock
## subtly change the color of your Windsurf workspace. Ideal when you have multiple Windsurf instances, use VS Live Share, or use Windsurf's Remote features, and you want to quickly identify your editor.
windsurf --install-extension johnpapa.vscode-peacock

# PHP Debug
## this extension is a debug adapter between Windsurf and Xdebug by Derick Rethans. Xdebug is a PHP extension (a .so file on Linux and a .dll on Windows) that needs to be installed on your server.
windsurf --install-extension xdebug.php-debug
...
#NOT WORKING FOR WINDSURF# windsurf --install-extension platformio.platformio-ide
...
## make TypeScript errors prettier and more human-readable in Windsurf
...
# vscode-pdf
## helps you to display pdf in Windsurf.
...
windsurf --install-extension evilz.vscode-reveal

# Vue-Official
## this extension provides language support for Vue
windsurf --install-extension vue.volar

# WakaTime
## an open source Windsurf plugin for metrics, insights, and time tracking automatically generated from your programming activity.
windsurf --install-extension wakatime.vscode-wakatime
```
